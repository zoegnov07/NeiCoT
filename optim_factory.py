...
try:
    from apex.optimizers import FusedNovoGrad, FusedAdam, FusedLAMB, FusedSGD   # type: ignore
    has_apex = True
except ImportError:
    has_apex = False
...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None):
    ...
    # print("Param groups = %s" % json.dumps(parameter_group_names, indent=2))        # 编码器和解码器的一些结构显示
